...
<!-- coverage:start -->
**503 of 597 topics** have their arithmetic replayed and asserted on every build
...
The remaining 94 load and expose a callable entry point, but ship no machine-readable
...
|---|---|--:|---|
| `record-transform` | `(input) → output` | 423 | backward-split-adjustment |
...
<!-- stats:start -->
**597 topics** · 18 domains · 78 families
...
| D06 | 52 | 5 | Price Action and Candlesticks |
...
| D14 | 20 | 4 | Portfolio Construction |
...
| D46 | 8 | 2 | Earnings and Per-Share Analytics |
<!-- stats:end -->
...
**Trend Smoothing** — [Simple Moving Average (SMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/sma/) · [Exponential Moving Average (EMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/ema/) · [Weighted Moving Average (WMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/wma/) · [Wilder RMA](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/wilder-rma/) · [Double Exponential Moving Average (DEMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/dema/) · [Triple Exponential Moving Average (TEMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/tema/) · [Hull MA](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/hull-ma/) · [Kaufman Adaptive Moving Average (KAMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/kama/) · [MESA Adaptive Moving Average (MAMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/mama/) · [Triangular Moving Average (TRIMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/triangular-moving-average-trima/) · [Tillson T3 Moving Average](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/tillson-t3-moving-average/) · [Following Adaptive Moving Average (FAMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/following-adaptive-moving-average-fama/) · [Arnaud Legoux Moving Average (ALMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/arnaud-legoux-moving-average-alma/) · [Fractal Adaptive Moving Average (FRAMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/fractal-adaptive-moving-average-frama/) · [Zero-Lag Exponential Moving Average (ZLEMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/zero-lag-exponential-moving-average-zlema/) · [Least-Squares Moving Average (LSMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/least-squares-moving-average-lsma/) · [Variable Index Dynamic Average (VIDYA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/variable-index-dynamic-average-vidya/) · [McGinley Dynamic](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/mcginley-dynamic/) · [Jurik-Style Moving Average Design](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/jurik-style-moving-average-design/) · [Volume-Weighted Moving Average (VWMA)](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/volume-weighted-moving-average-vwma/) · [Quadratic-Weighted Moving Average](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/quadratic-weighted-moving-average/) · [Gaussian Moving Average](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/gaussian-moving-average/) · [Ehlers Super Smoother Filter](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/ehlers-super-smoother-filter/) · [Ehlers Instantaneous Trendline](https://docs.thefintechbuilder.com/technical-indicators/trend-smoothing/ehlers-instantaneous-trendline/)

**Trend Systems** — [MACD](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/macd/) · [Percentage Price Oscillator (PPO)](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/percentage-price-oscillator/) · [Aroon Up, Down, and Oscillator](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/aroon/) · [Directional Movement](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/directional-movement/) · [Average Directional Index (ADX)](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/adx/) · [Ichimoku Cloud](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/ichimoku-cloud/) · [Parabolic SAR](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/parabolic-sar/) · [Supertrend](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/supertrend/) · [Average Directional Index Rating (ADXR)](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/average-directional-index-rating-adxr/) · [Vortex Indicator (+VI/−VI)](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/vortex-indicator-vi-vi/) · [Choppiness Index](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/choppiness-index/) · [Trend Intensity Index](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/trend-intensity-index/) · [QStick](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/qstick/) · [Mass Index](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/mass-index/) · [Vertical Horizontal Filter](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/vertical-horizontal-filter/) · [Random Walk Index (High/Low)](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/random-walk-index-high-low/) · [Trend Trigger Factor](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/trend-trigger-factor/) · [Directional Trend Index](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/directional-trend-index/) · [Trend Strength Index](https://docs.thefintechbuilder.com/technical-indicators/trend-systems/trend-strength-index/)

**Momentum** — [Relative Strength Index (RSI)](https://docs.thefintechbuilder.com/technical-indicators/momentum/rsi/) · [Stochastic Oscillator](https://docs.thefintechbuilder.com/technical-indicators/momentum/stochastic-oscillator/) · [Stochastic RSI](https://docs.thefintechbuilder.com/technical-indicators/momentum/stochastic-rsi/) · [Williams %R](https://docs.thefintechbuilder.com/technical-indicators/momentum/williams-r/) · [Commodity Channel Index (CCI)](https://docs.thefintechbuilder.com/technical-indicators/momentum/cci/) · [Ultimate Oscillator](https://docs.thefintechbuilder.com/technical-indicators/momentum/ultimate-oscillator/) · [True Strength Index (TSI)](https://docs.thefintechbuilder.com/technical-indicators/momentum/tsi/) · [Connors RSI](https://docs.thefintechbuilder.com/technical-indicators/momentum/connors-rsi/) · [Absolute Price Oscillator](https://docs.thefintechbuilder.com/technical-indicators/momentum/absolute-price-oscillator/) · [Rate-of-Change Variants (ROC, ROCP, and ROCR)](https://docs.thefintechbuilder.com/technical-indicators/momentum/rate-of-change-variants-roc-rocp-and-rocr/) · [Price Momentum (MOM)](https://docs.thefintechbuilder.com/technical-indicators/momentum/price-momentum-mom/) · [Chande Momentum Oscillator](https://docs.thefintechbuilder.com/technical-indicators/momentum/chande-momentum-oscillator/) · [Awesome Oscillator](https://docs.thefintechbuilder.com/technical-indicators/momentum/awesome-oscillator/) · [Accelerator Oscillator](https://docs.thefintechbuilder.com/technical-indicators/momentum/accelerator-oscillator/) · [TRIX](https://docs.thefintechbuilder.com/technical-indicators/momentum/trix/) · [Stochastic Momentum Index](https://docs.thefintechbuilder.com/technical-indicators/momentum/stochastic-momentum-index/) · [Relative Vigor Index](https://docs.thefintechbuilder.com/technical-indicators/momentum/relative-vigor-index/) · [Relative Momentum Index](https://docs.thefintechbuilder.com/technical-indicators/momentum/relative-momentum-index/) · [Fisher Transform](https://docs.thefintechbuilder.com/technical-indicators/momentum/fisher-transform/) · [Inverse Fisher Transform](https://docs.thefintechbuilder.com/technical-indicators/momentum/inverse-fisher-transform/) · [Schaff Trend Cycle](https://docs.thefintechbuilder.com/technical-indicators/momentum/schaff-trend-cycle/) · [Quantitative Qualitative Estimation (QQE)](https://docs.thefintechbuilder.com/technical-indicators/momentum/quantitative-qualitative-estimation-qqe/) · [WaveTrend Oscillator](https://docs.thefintechbuilder.com/technical-indicators/momentum/wavetrend-oscillator/) · [Know Sure Thing (KST)](https://docs.thefintechbuilder.com/technical-indicators/momentum/know-sure-thing-kst/) · [Chande Forecast Oscillator](https://docs.thefintechbuilder.com/technical-indicators/momentum/chande-forecast-oscillator/) · [Detrended Price Oscillator](https://docs.thefintechbuilder.com/technical-indicators/momentum/detrended-price-oscillator/) · [Balance of Power](https://docs.thefintechbuilder.com/technical-indicators/momentum/balance-of-power/) · [Psychological Line](https://docs.thefintechbuilder.com/technical-indicators/momentum/psychological-line/) · [Pretty Good Oscillator](https://docs.thefintechbuilder.com/technical-indicators/momentum/pretty-good-oscillator/) · [Price Momentum Oscillator](https://docs.thefintechbuilder.com/technical-indicators/momentum/price-momentum-oscillator/)
...
**Volume Indicators** — [On-Balance Volume (OBV)](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/obv/) · [Accumulation/Distribution Line](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/accumulation-distribution-line/) · [Chaikin Money Flow](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/chaikin-money-flow/) · [Money Flow Index](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/money-flow-index/) · [Volume Price Trend](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/volume-price-trend/) · [Force Index](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/force-index/) · [Chaikin A/D Oscillator](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/chaikin-a-d-oscillator/) · [Session VWAP Indicator](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/session-vwap-indicator/) · [Anchored VWAP](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/anchored-vwap/) · [Negative Volume Index](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/negative-volume-index/) · [Positive Volume Index](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/positive-volume-index/) · [Ease of Movement](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/ease-of-movement/) · [Klinger Volume Oscillator](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/klinger-volume-oscillator/) · [Volume Oscillator](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/volume-oscillator/) · [Percentage Volume Oscillator](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/percentage-volume-oscillator/) · [Volume Rate of Change](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/volume-rate-of-change/) · [Relative Volume](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/relative-volume/) · [Money Flow Multiplier and Money Flow Volume](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/money-flow-multiplier-and-money-flow-volume/) · [Volume-Weighted MACD](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/volume-weighted-macd/) · [Volume Zone Oscillator](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/volume-zone-oscillator/) · [Twiggs Money Flow](https://docs.thefintechbuilder.com/technical-indicators/volume-indicators/twiggs-money-flow/)

**Range and Volatility Indicators** — [Normalized ATR and ATR Percentage](https://docs.thefintechbuilder.com/technical-indicators/range-and-volatility-indicators/normalized-atr-and-atr-percentage/) · [Chaikin Volatility](https://docs.thefintechbuilder.com/technical-indicators/range-and-volatility-indicators/chaikin-volatility/) · [Ulcer Index](https://docs.thefintechbuilder.com/technical-indicators/range-and-volatility-indicators/ulcer-index/) · [Relative Volatility Index](https://docs.thefintechbuilder.com/technical-indicators/range-and-volatility-indicators/relative-volatility-index/) · [Volatility Ratio](https://docs.thefintechbuilder.com/technical-indicators/range-and-volatility-indicators/volatility-ratio/) · [Volatility Quality Index](https://docs.thefintechbuilder.com/technical-indicators/range-and-volatility-indicators/volatility-quality-index/) · [Average Daily Range](https://docs.thefintechbuilder.com/technical-indicators/range-and-volatility-indicators/average-daily-range/) · [Gap Volatility](https://docs.thefintechbuilder.com/technical-indicators/range-and-volatility-indicators/gap-volatility/) · [Range Efficiency Ratio](https://docs.thefintechbuilder.com/technical-indicators/range-and-volatility-indicators/range-efficiency-ratio/) · [High-Low Range Percentage](https://docs.thefintechbuilder.com/technical-indicators/range-and-volatility-indicators/high-low-range-percentage/) · [Normalized Price Range](https://docs.thefintechbuilder.com/technical-indicators/range-and-volatility-indicators/normalized-price-range/) · [Volatility Stop](https://docs.thefintechbuilder.com/technical-indicators/range-and-volatility-indicators/volatility-stop/)

**Bands, Envelopes, and Squeezes** — [Bollinger %B](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/bollinger-percent-b/) · [Moving Average Envelope](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/moving-average-envelope/) · [ATR Bands](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/atr-bands/) · [Standard Deviation Channel](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/standard-deviation-channel/) · [Regression Channel](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/regression-channel/) · [Raff Regression Channel](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/raff-regression-channel/) · [STARC Bands](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/starc-bands/) · [Fractal Chaos Bands](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/fractal-chaos-bands/) · [Projection Bands](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/projection-bands/) · [Dynamic Zone Bands](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/dynamic-zone-bands/) · [TTM Squeeze](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/ttm-squeeze/) · [Squeeze Momentum](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/squeeze-momentum/) · [Adaptive Price Zone](https://docs.thefintechbuilder.com/technical-indicators/bands-envelopes-and-squeezes/adaptive-price-zone/)

**Price Transforms** — [Typical Price](https://docs.thefintechbuilder.com/technical-indicators/price-transforms/typical-price/) · [Median Price Transform](https://docs.thefintechbuilder.com/technical-indicators/price-transforms/median-price-transform/) · [Weighted Close](https://docs.thefintechbuilder.com/technical-indicators/price-transforms/weighted-close/) · [Average Price Transform](https://docs.thefintechbuilder.com/technical-indicators/price-transforms/average-price-transform/) · [Heikin-Ashi Transform](https://docs.thefintechbuilder.com/technical-indicators/price-transforms/heikin-ashi-transform/) · [Log Price Transform](https://docs.thefintechbuilder.com/technical-indicators/price-transforms/log-price-transform/) · [Price Relative](https://docs.thefintechbuilder.com/technical-indicators/price-transforms/price-relative/) · [Normalized Price Transform](https://docs.thefintechbuilder.com/technical-indicators/price-transforms/normalized-price-transform/)

**Rolling Statistical Indicators** — [Rolling Percentile](https://docs.thefintechbuilder.com/technical-indicators/rolling-statistical-indicators/rolling-percentile/) · [Rolling Quantile](https://docs.thefintechbuilder.com/technical-indicators/rolling-statistical-indicators/rolling-quantile/) · [Rolling Beta](https://docs.thefintechbuilder.com/technical-indicators/rolling-statistical-indicators/rolling-beta/) · [Rolling Alpha](https://docs.thefintechbuilder.com/technical-indicators/rolling-statistical-indicators/rolling-alpha/)


### D08 — Geometric Chart Patterns · 64 topics

**Pivots and Levels** — [Causal Pivot Detection](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/causal-pivot-detection/) · [ZigZag Segmentation](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/zigzag-segmentation/) · [Support/Resistance Clustering](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/support-resistance-clustering/) · [Robust Trendline Fitting](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/robust-trendline-fitting/) · [Classic and Floor-Trader Pivot Points](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/classic-and-floor-trader-pivot-points/) · [Fibonacci Pivot Points](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/fibonacci-pivot-points/) · [Camarilla Pivot Points](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/camarilla-pivot-points/) · [Woodie Pivot Points](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/woodie-pivot-points/) · [DeMark Pivot Points](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/demark-pivot-points/) · [Rolling Support and Resistance](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/rolling-support-and-resistance/) · [Fractal Support and Resistance](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/fractal-support-and-resistance/) · [ATR Support and Resistance](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/atr-support-and-resistance/) · [Pivot Range Width](https://docs.thefintechbuilder.com/geometric-chart-patterns/pivots-and-levels/pivot-range-width/)
...
**Market Structure, Breakouts, and Regimes** — [Highest-High and Lowest-Low Primitives](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/highest-high-and-lowest-low-primitives/) · [Single-Asset New-High/New-Low Signal](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/single-asset-new-high-new-low-signal/) · [Breakout Strength](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/breakout-strength/) · [Donchian Breakout](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/donchian-breakout/) · [Opening Range Breakout](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/opening-range-breakout/) · [Price Compression Index](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/price-compression-index/) · [Range Expansion Index](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/range-expansion-index/) · [Fractal Dimension Index](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/fractal-dimension-index/) · [Hurst Exponent](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/hurst-exponent/) · [Efficiency Ratio](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/efficiency-ratio/) · [Market Meanness Index](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/market-meanness-index/) · [Trend/Range Regime Classifier](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/trend-range-regime-classifier/) · [Volatility Regime Classifier](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/volatility-regime-classifier/) · [Directional Persistence](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/directional-persistence/) · [Swing Structure Detector](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/swing-structure-detector/) · [Higher-High/Lower-Low Structure](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/higher-high-lower-low-structure/) · [Inside/Outside Bar Structure](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/inside-outside-bar-structure/) · [Market Entropy](https://docs.thefintechbuilder.com/geometric-chart-patterns/market-structure-breakouts-and-regimes/market-entropy/)
...
### D14 — Portfolio Construction · 20 topics
...
### D46 — Earnings and Per-Share Analytics · 8 topics

**Earnings and Share Foundations** — [Stock-Split/Consolidation EPS Restatement](https://docs.thefintechbuilder.com/earnings-and-per-share-analytics/earnings-and-share-foundations/stock-split-consolidation-eps-restatement/) · [Bonus-Issue EPS Restatement](https://docs.thefintechbuilder.com/earnings-and-per-share-analytics/earnings-and-share-foundations/bonus-issue-eps-restatement/) · [Rights-Issue Bonus-Factor Adjustment](https://docs.thefintechbuilder.com/earnings-and-per-share-analytics/earnings-and-share-foundations/rights-issue-bonus-factor-adjustment/) · [Basic EPS](https://docs.thefintechbuilder.com/earnings-and-per-share-analytics/earnings-and-share-foundations/basic-eps/)

**Basic and Diluted EPS** — [If-Converted Convertible-Debt Dilution](https://docs.thefintechbuilder.com/earnings-and-per-share-analytics/basic-and-diluted-eps/if-converted-convertible-debt-dilution/) · [If-Converted Convertible-Preference Dilution](https://docs.thefintechbuilder.com/earnings-and-per-share-analytics/basic-and-diluted-eps/if-converted-convertible-preference-dilution/) · [Treasury-Share Method for Options/Warrants](https://docs.thefintechbuilder.com/earnings-and-per-share-analytics/basic-and-diluted-eps/treasury-share-method-for-options-warrants/) · [Contingently Issuable Shares](https://docs.thefintechbuilder.com/earnings-and-per-share-analytics/basic-and-diluted-eps/contingently-issuable-share-inclusion/)
<!-- topics:end -->
