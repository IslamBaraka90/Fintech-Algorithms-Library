...
Bringing your own data is a short mapping function that *you* own — see
[`demos/05-bring-your-own-data.ts`](demos/05-bring-your-own-data.ts). When a vendor changes
their API you edit one adapter; the algorithms never move.
...
npm run demo     # run all six demos
...
See [HANDOFF.md](HANDOFF.md) for the full testing, demo and contribution workflow.
